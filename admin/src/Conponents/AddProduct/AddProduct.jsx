    ...
    const handleAddProduct = async () => {
        try {
            ...
            if (mainFile) {
                ...
                const mainResp = await fetch('https://graffiti-streetwear.onrender.com/upload', { method: 'POST', body: mainForm });
            ...
            for (let file of sideFiles) {
                ...
                const sideResp = await fetch('https://graffiti-streetwear.onrender.com/upload', { method: 'POST', body: sideForm });
            ...
            const addResp = await fetch('https://graffiti-streetwear.onrender.com/addproduct', {
                method: 'POST',
